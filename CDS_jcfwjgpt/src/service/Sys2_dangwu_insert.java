...
/**
 * Servlet implementation class Sys2_dangwu_insert
 */
@WebServlet("/Sys2_dangwu_insert")
public class Sys2_dangwu_insert extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Sys2_dangwu_insert() {
        super();
