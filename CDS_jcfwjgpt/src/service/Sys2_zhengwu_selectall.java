...
/**
 * Servlet implementation class Sys2_zhengwu_selectall
 */
@WebServlet("/Sys2_zhengwu_selectall")
public class Sys2_zhengwu_selectall extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Sys2_zhengwu_selectall() {
        super();
