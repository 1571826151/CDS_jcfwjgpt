...
/**
 * Servlet implementation class Sys2_dangwu_select
 */
@WebServlet("/Sys2_dangwu_select")
public class Sys2_dangwu_select extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Sys2_dangwu_select() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(num.equals("1")){
			...
			try {
				list = dbgq.QueryByTime(str1, str2, "党务公开");
				dbgq.clean();
			} catch (Exception e) {
				// TODO: handle exception
			}
			...
			try {
				list = dbgq.QueryByName(str , "党务公开");
				dbgq.clean();
			} catch (Exception e) {
				// TODO: handle exception
			}
			...
			try {
				list1 = dbgj.QueryByTime(str1, str2, "党务公开");
				dbgq.clean();
			} catch (Exception e) {
				// TODO: handle exception
			}
			...
			try {
				list1 = dbgj.QueryByJie(str , "党务公开");
				dbgj.clean();
			} catch (Exception e) {
				// TODO: handle exception
			}
			...
			try {
				list1 = dbgj.QueryByName(str , "党务公开");
				dbgj.clean();
			} catch (Exception e) {
				// TODO: handle exception
			}
